...
class CMC(BaseClient):
    ...
    def getRealtime(self, ticker, datacode, key):
        ...
        url = 'https://pro-api.coinmarketcap.com/products/{}/stats'.format(ticker)
        ...
        try:
            ...
            del self.realtime[ticker]
            return 'CMC.getRealtime({}, {}) - urlopen: {}'.format(ticker, datacode, e)
        ...
        try:
            ...
            del self.realtime[ticker]
            return 'CMC.getRealtime({}, {}) - crumb: {}'.format(ticker, datacode, e)
        ...
        try:
            ...
            logger.exception("BaseException ticker=%s datacode=%s", ticker, datacode)
            del self.realtime[ticker]
            return 'CMC.getRealtime({}, {}) - process: {}'.format(ticker, datacode, e)
